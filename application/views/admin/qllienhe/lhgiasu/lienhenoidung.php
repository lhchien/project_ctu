...
<div class="container">
    ...
    $trangthai = array("lh_trangthai" => 0);
    $this->m_lienhe->updatettlienhe($id,$trangthai);
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <div class="col-lg-12">
                    <table class="table">
                        <tr>
                    		 <td><strong><?php echo $lienhe->gs_hoten.":"; ?></strong></td>
...
<div class="panel panel-primary">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
         <form class="form-horizontal" action="<?php echo base_url(); ?>qllienhe/noidung_lh/<?php echo $this->uri->segment(3);?>" method="post" enctype="multipart/form-data">
