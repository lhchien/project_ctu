            ...
            <div class="col-md-9">
                <form class="form-horizontal" action="<?php echo base_url(); ?>qlphuhuynh/editInfo_ph/<?php echo $phuhuynh->ph_tk_id ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-3 control-label" for="txtTrangThai">Trạng thái </label>
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="txtTrangThai"  value="<?php echo $phuhuynh->ph_trangthai==2 ? "Block" : "Active";?>" disabled/> 
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="txtDiachi" placeholder="Nhập trình độ..."  value="<?php echo empty(set_value('txtDiachi')) && isset($phuhuynh) ? $phuhuynh->ph_diadiem : set_value('txtDiachi');?>"/> 
