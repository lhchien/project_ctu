...
<div class="container">
    ...
    <?php
    $sql = "SELECT * FROM taikhoan t, giasu g WHERE t.tk_id=g.gs_tk_id AND gs_tk_id = ".$this->uri->rsegment('3') ;
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="col-md-9">
                <form class="form-horizontal" action="<?php echo base_url(); ?>qlgiasu/editInfo_gs/<?php echo $giasu->gs_tk_id ?> " method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" class="form-control" name="txtEmail"  value="<?php echo $giasu->tk_email;?>" disabled/> 
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
