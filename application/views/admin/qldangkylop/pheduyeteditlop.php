...
<div class="container">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Thông tin lớp đăng ký dạy</div>
        <div class="panel-body">
            <div class="col-md-11">
                <form class="form-horizontal" action="<?php echo base_url(); ?>qldangkylop/dkeditInfo_ld/<?php echo $lopday->ld_id ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-4 control-label" for="txtHotenph">Phụ huynh </label>
                                <div class="col-lg-8">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="col-lg-5 control-label" for="txtPass">Trạng thái lớp học </label>
                                <div class="col-lg-7">
