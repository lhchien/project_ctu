<div class="container">
		...
		<form action="<?php echo base_url(); ?>qllopday/delete_ld/<?php echo $ld_id; ?>" method="POST">
			<div class="alert alert-block alert-danger">
				...
				<p>Nếu bạn xóa, hãy chắc chắn!
					...
					<a href="<?php echo base_url(); ?>qllopday/index"><button type="button" name="cancelDel" id="cancelDel" class="btn btn-default">Hủy</button></a>
				</p>
			</div>
		</form>
		<?php
	...
	<h2 class="text-center text-info">Danh sách các lớp được mở</h2>
	<div class="row">
	...
	<table class="table table-striped table-hover table-bordered">
		...
		<tbody>
            ...
            $config['base_url'] = base_url().'qllopday/index';
			...
			foreach ($lopday as $lopday) { 
				...
				<tr>
					...
					<td class="text-center">
						<a href="<?php echo base_url(); ?>qllopday/detail_ld/<?php echo $lopday->ld_id; ?>">
							<button type="button" class="btn btn-xs btn-info" value="Xem"><span class="glyphicon glyphicon-info-sign"></span>&nbsp;Xem</button>
						</a>
						<a href="<?php echo base_url(); ?>qllopday/edit/<?php //echo $row['tv_id']; ?>">
							<button type="button" class="btn btn-xs btn-warning" value="Sửa"><span class="glyphicon glyphicon-pencil"></span>&nbsp;Sửa</button>
						</a>
						<a href="<?php echo base_url(); ?>qllopday/edit/<?php //echo $row['tv_id']; ?>">
							<button type="button" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-list"></span>&nbsp;Gia sư</button>
						</a>
						<a href="<?php echo base_url(); ?>qllopday/active_ld/<?php echo $lopday->ld_id; ?>">
