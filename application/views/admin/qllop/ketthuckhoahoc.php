<div class="container">
	...
	if(isset($confirm) && $confirm=="yes"){ ?>
		<form action="<?php echo base_url(); ?>qllopday/ketthuckhoahocdelete_ld/<?php echo $ld_id; ?>" method="POST">
			<div class="alert alert-block alert-danger">
				<h4>Cảnh báo xóa!</h4>
				<p>Nếu bạn xóa, hãy chắc chắn!
					<input type="submit" name="submit" class="btn btn-danger" value="Xóa">
					<a href="<?php echo base_url(); ?>qllopday/ketthuckhoahoc_ld"><button type="button" name="cancelDel" id="cancelDel" class="btn btn-default">Hủy</button></a>
				</p>
			</div>
		</form>
		<?php
	...
	<h2 class="text-center text-info">Danh sách các lớp đả kết thúc khóa học</h2>
...
<div class="row">
	...
	<table class="table table-striped table-hover table-bordered">
		...
		<tbody>
            ...
            $config['base_url'] = base_url().'qllopday/ketthuckhoahoc_ld'; 
			$sql1 = "SELECT * FROM lopday l, dangky d WHERE l.ld_id = d.dk_ld_id AND ld_trangthai=1 AND dk_trangthai=-2";
			...
			foreach ($lopday as $lopday) { 
				...
				<tr>
					...
					<?php
					$sql1="SELECT * FROM dangky WHERE dk_ld_id=$lopday->ld_id AND dk_trangthai=-2 ";
					...
					<td class="text-center">
						...
						<a target="_blank" href="<?php echo base_url(); ?>qllopday/kethuckhoahocdetail_ld/<?php echo $lopday->ld_id; ?>">
						...
						<a href="<?php echo base_url(); ?>qllopday/ketthuckhoahocdelete_ld/<?php echo $lopday->ld_id; ?>">
