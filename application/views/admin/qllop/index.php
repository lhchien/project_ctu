<div class="container">
		...
		<form action="<?php echo base_url(); ?>qllop/delete_ld/<?php echo $ld_id; ?>" method="POST">
			<div class="alert alert-block alert-danger">
				...
				<p>Nếu bạn xóa, hãy chắc chắn!
					...
					<a href="<?php echo base_url(); ?>qllop/index"><button type="button" name="cancelDel" id="cancelDel" class="btn btn-default">Hủy</button></a>
				</p>
			</div>
		</form>
		<?php
	...
	<table class="table table-striped table-hover table-bordered">
		...
		<tbody>
            ...
            $config['base_url'] = base_url().'qllop/index';
			...
			foreach ($lopday as $lopday) { 
				...
				<tr>
					...
					<td class="text-center">
						...
						<a href="<?php echo base_url(); ?>qllop/active_ld/<?php echo $lopday->ld_id; ?>">
