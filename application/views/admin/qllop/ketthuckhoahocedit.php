...
<div class="container">
    ...
    <?php
        $sql = "SELECT * FROM taikhoan t, phuhuynh p, lopday l, dangky d, giasu g WHERE t.tk_id =p.ph_tk_id AND p.ph_tk_id=l.ph_tk_id AND l.ld_id=d.dk_ld_id AND d.dk_gs_id = g.gs_tk_id AND ld_trangthai = 1 AND dk_trangthai = -2 AND l.ld_id = ".$this->uri->rsegment('3') ;
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">Thông tin lớp đả kết thúc khóa học</div>
