            ...
            <div class="col-md-12">
                <div class="col-lg-5">
                    ...
                    <table class="table">
                        <tr>
                    		<td>Tiêu đề:</td>
                    		<td class="text-right"><strong><?php echo ($lopday->ld_tieude == "")?"Chưa cập nhật": $lopday->ld_tieude; ?></strong></td>
                    	</tr>
                ...
                <div class="col-lg-7">
                    <table class="table">
                        ...
                        <tr>
                    		<td>Khối lớp:</td>
                    		<td class="text-right"><strong><?php echo ($lopday->ld_khoilop == "")?"Chưa cập nhật": $lopday->ld_khoilop; ?></strong></td>
                    	</tr>
                        <tr>
                    		<td> Dạy môn:</td>
                    		<td class="text-right"><strong><?php echo ($lopday->ld_mon == "")?"Chưa cập nhật": $lopday->ld_mon; ?></strong></td>
                    	</tr>
                    	<tr>
                ...
                <div class="col-lg-7 text-justify">
                	<center><h4 class="text-muted">Yêu cầu</h4></center>
