...
<div class="container">
    ...
    <h2 class="text-lg"><span class="text-muted">Mở lớp</span> cần gia sư</h2>
    <?php
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            <div class="col-md-12">
                <form class="form-horizontal" action="<?php echo base_url(); ?>phuhuynh/opennewclass" method="post" enctype="multipart/form-data">

                    <div class="form-group">
                        <label class="col-lg-3 control-label" for="txtTitle">Tiêu đề: <span class="text-danger"><strong>(*)</strong></span></label>
                        <div class="col-lg-7">
                            <input type="text" class="form-control form-hg" name="txtTitle" placeholder="Nhập tiêu đề của lớp..."  value="<?php echo set_value('txtTitle')?>"/> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <label class="sr-only" for="exampleInputEmail3">Class</label>
                                   <?php empty(set_value('slMount')) ? Mylibrary::showSoLuong() : Mylibrary::showSoLuong(set_value('slMount')); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <?php
                            empty(set_value('checkBuoi')) ? Mylibrary::checkBuoiHoc() : Mylibrary::checkBuoiHoc(set_value('checkBuoi'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="time" class="form-control form-hg" name="txtTime" value="<?php echo set_value('txtTime');?>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-3">
                            <input type="text" id="element_3" class="form-control" name="lat" placeholder="Kinh tuyến" maxlength="255" value="<?php echo set_value('lat');?>" readonly="true"/> 
                        </div>
                        <div class="col-lg-3">
                            <input type="text" id="element_4" class="form-control" name="lng" placeholder="Vĩ tuyến" maxlength="255" value="<?php echo set_value('lng');?>" readonly="true"/> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <textarea class="form-control" data-toggle="tooltip" data-placement="top" name="mota_diadiem" rows="2"> <?php echo set_value('mota_diadiem');?> </textarea> 
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <textarea name="mota_yeucau" id="description" class="form-control" rows="5"><?php echo set_value('mota_yeucau');?></textarea>
                        </div>
                    </div>

                    <div class="col-sm-7 pull-right">
                        <input type="submit" name="submit" class="btn btn-warning btn-lg" value="Hoàn tất">
                    </div>
